...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
    	final Product p1 = new ComparableProduct(new ProductImpl("Sennheiser HD 800", 10));
        final Product p2 = new ComparableProduct(new ProductImpl("Xiaomi POCO X3", 30));
        final Product p3 = new ComparableProduct(new ProductImpl("Boh", 1000));

        final Warehouse w = new OrderedWarehouse(new WarehouseImpl());
        w.addProduct(p3);
        w.addProduct(p1);
        w.addProduct(p2);
